...
export type ImageViewerProps = {
    ...
    onSingleTap?: (x: number, y: number, width: number, height: number) => unknown;
...
export default function ImageViewer({
    ...
    const { width: finalWidth, height: finalHeight } = useMemo(() => {
        ...
        } else if (resizedBasedOnHeight.width > containerWidth) {
    ...
    const singleTap = Gesture.Tap().onEnd((event) => {
        ...
        onSingleTap && runOnJS(onSingleTap)(scaledTapX, scaledTapY, finalWidth, finalHeight);
    });
        ...
        <GestureDetector gesture={allGestures}>
            ...
            >
                <Animated.View style={imageContainerAnimatedStyle}>
                    <Animated.View style={[imageAnimatedStyle, { width: finalWidth, height: finalHeight }]}>
                        <Animated.Image
